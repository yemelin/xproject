...
func (c *Client) prepareQueries(ctx context.Context) error {
	...
	c.queries["selectFromAccounts"], err = c.idb.PrepareContext(ctx,
	...
	c.queries["deleteFromAccounts"], err = c.idb.PrepareContext(ctx,
	...
	c.queries["selectFromCsvFiles"], err = c.idb.PrepareContext(ctx,
	...
	c.queries["insertIntoCsvFiles"], err = c.idb.PrepareContext(ctx,
	...
	c.queries["deleteFromCsvFiles"], err = c.idb.PrepareContext(ctx,
	...
	c.queries["selectFromBills"], err = c.idb.PrepareContext(ctx,
	...
	c.queries["selectBillsByTime"], err = c.idb.PrepareContext(ctx,
	...
	c.queries["selectBillsByService"], err = c.idb.PrepareContext(ctx,
	...
	c.queries["selectBillsByProject"], err = c.idb.PrepareContext(ctx,
	...
	c.queries["selectLastBill"], err = c.idb.PrepareContext(ctx,
	...
	c.queries["insertIntoBills"], err = c.idb.PrepareContext(ctx,
	...
	c.queries["deleteFromBills"], err = c.idb.PrepareContext(ctx,
